...
public:
    Point() {}
    Point(double _x, double _y, double _z) //_x to nazwa zmiennej, nie operator
    {
        x=_x; y=_y; z=_z;
    }
...
public:
    ...
    //moveTo(Point P); przesuwa plaszczyzne tak, zeby byla rownolegla i przechodzila przez podany punkt
